...
public class DroneDeliveryCustomer extends Customer {
	...
	public DroneDeliveryCustomer(String name, String mobileNumber, int locationX, int locationY) throws CustomerException {
		...
		if(locationX == 0 && locationY == 0){
			throw new CustomerException("Cant deliver at your location, your already at our restaurant!!");
		}
		else{
			this.xLocation = locationX;
	...
	public double getDeliveryDistance() {
		double x = Math.pow(xLocation - 0, 2);
		double y = Math.pow(yLocation - 0, 2);
